...
#     prompt = (
#         f"You are a highly skilled translator proficient in multiple languages. Your task is to translate the following text from {source_lang} to {target_lang} accurately and fluently, preserving its meaning, tone, and context. Ensure that the translation is grammatically correct, natural, and contextually relevant. Only provide the translated text in response without any additional information.\n\n"
#         f"Source Text: \"{text}\"\n\nTranslated Text: "
#     )
